...
{#if showControls}
  ...
  >
    <CircleIconButton buttonSize="50" icon={mdiClose} on:click={onClose} title="Sortir du Diaporama" />
    ...
    />
    <CircleIconButton buttonSize="50" icon={mdiChevronLeft} on:click={onPrevious} title="Précédent" />
    <CircleIconButton buttonSize="50" icon={mdiChevronRight} on:click={onNext} title="Suivant" />
    <CircleIconButton buttonSize="50" icon={mdiCog} on:click={() => (showSettings = !showSettings)} title="Suivant" />
    {#if !isFullScreen}
      <CircleIconButton
        buttonSize="50"
        icon={mdiFullscreen}
        on:click={onSetToFullScreen}
        title="Diaporama en plein écran"
      />
    {/if}
  </div>
{/if}
