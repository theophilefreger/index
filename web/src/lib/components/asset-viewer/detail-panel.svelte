...
<section class="relative p-2 dark:bg-immich-dark-bg dark:text-immich-dark-fg">
    ...
    <section class="px-4 py-4">
      <div role="alert">
        ...
        <div class="rounded-b border border-t-0 border-red-400 bg-red-100 px-4 py-3 text-red-700">
          <p>
            Cette ressource est hors ligne. La Mémoire Vive ne peut pas accéder à son emplacement de fichier.
            Assurez-vous que la ressource est disponible, puis relancez la numérisation de la bibliothèque.
          </p>
        </div>
      </div>
    </section>
                ...
                {#if age >= 0}
                  ...
                  >
                    ...
                    {:else if ageInMonths > 12 && ageInMonths <= 23}
                      Age 1 année, {ageInMonths - 12} mois
                    {:else}
                      Age {age}
                    {/if}
                  </p>
  ...
  <div class="px-4 py-4">
    ...
    {:else}
      <p class="text-sm">PAS D'INFO EXIF DISPONIBLE</p>
    {/if}
        ...
        <div class="flex gap-4 py-2 hover:cursor-pointer items-center">
          ...
          <div class="mb-auto mt-auto">
            ...
            <div class="flex flex-col gap-0 text-sm">
              <div>
                <span>{album.assetCount} éléments</span>
                {#if album.shared}
                  <span> • Partagé</span>
                {/if}
              </div>
